...
namespace Random_Track_Generation
{
    class GenerateStraightLineTrackButton : Button
    {
        ...
        public GenerateStraightLineTrackButton(int newHeight, int newWidth, string text, Vector2 position, SpriteFont newfont, MouseState mstate, Vector2 topLeftBorder, Vector2 bottomRightBorder, Color newColor) : base(newHeight, newWidth, text, position, newfont, mstate, newColor)
        {
            font = newfont;
        ...
        public void Update(GameTime gameTime, MouseState mState, ref Track currentTrack, ref Car currentCar, ref Car[] trainingCars, ref string statusString)
        {
